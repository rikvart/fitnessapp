...
public class FitnessappApplication {
	...
	public CommandLineRunner fitnessDemo(DataRepository repository, CategoryRepository crepository,
		...
		return (args) -> {
			...
			User user1 = new User("user", "$2a$06$3jYRJrg0ghaaypjZ/.g4SethoeA51ph3UD4kZi9oPkeMTpjKU5uo6", "USER_ROLE");
			User user2 = new User("admin", "$2a$10$0MMwY.IQqpsVc1jC8u7IJ.2rT8b0Cd3b3sfIBGV2zfgnPGtT4r0.C", "ADMIN_ROLE");
